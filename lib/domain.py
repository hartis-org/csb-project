...
class Domain(object):
    ...
    def __init__(self, minimum=Point(), maximum=Point()):
        ...
        self.__min = Point(minimum.get_c(0), minimum.get_c(1))
        self.__max = Point(maximum.get_c(0), maximum.get_c(1))
    ...
    def get_centroid(self):
        mid_x = self.__min.get_c(0) + (self.__max.get_c(0) - self.__min.get_c(0)) / 2.0
        mid_y = self.__min.get_c(1) + (self.__max.get_c(1) - self.__min.get_c(1)) / 2.0
    ...
    def intersects_polygon(self, polygon):
        node_rectangle = Polygon([(self.__min.get_c(0), self.__min.get_c(1)),
                                  (self.__min.get_c(0), self.__max.get_c(1)),
                                  (self.__max.get_c(0), self.__max.get_c(1)),
                                  (self.__max.get_c(0), self.__min.get_c(1))])
